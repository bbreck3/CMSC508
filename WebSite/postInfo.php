...
$temp = explode(" ", $prep);
  //$data = preg_split("/[\r\n,;]+/", $prep, -1, PREG_SPLIT_NO_EMPTY);

 $dataSize = sizeof($temp);


 //Prep the data for the database:
for($i = 0; $i < $dataSize;$i++)
{

 //For printing out for the blog 
//echo $data[$i];
//echo "<br>";
  
//For inserting datavalues in the the database
  $data1 .=$temp[$i]." ";
  //echo $data1;
  //echo "<br>";
}

//list that stores the values for the database
//echo $data1;
echo "<br>";
//echo $dataSize;
