      ...
      if(!$conn) {
        ...
        $temp2 = trim($res['ANSWER']);
          ...
          echo file_get_contents("public_html/standard/responce_answer/correct_answer.php");
            echo  file_get_contents("public_html/standard/linkToNext/linkToProblem3.php");
...
<form action="public_html/standard/problem_responce/problem2_responce.php" method="post">
