      ...
      if(!$conn) {
        ...
        $temp2 = trim($res['ANSWER']);
          ...
          if($temp1===$temp2) {
            ...
            echo  file_get_contents("/public_html/standard/linkToNext/linkToProblem2.php");
...
<form action="/public_html/standard/problem_responce/problem1_responce.php" method="post">
